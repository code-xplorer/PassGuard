...
class PinView @JvmOverloads constructor(
    ...
    private fun setupAnimator() {
        mDefaultAddAnimator = ValueAnimator.ofFloat(0.5f, 1f).apply {
            duration = 150
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            width = widthSize
            itemWidth = (widthSize - ViewCompat.getPaddingEnd(this) + ViewCompat.getPaddingStart(this) - ((mPinItemCount - 1) * mPinItemSpacing))/mPinItemCount
        } else {
